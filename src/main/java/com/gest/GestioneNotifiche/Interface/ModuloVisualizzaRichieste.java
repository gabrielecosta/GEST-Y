...
import com.gest.GestioneNotifiche.Control.gestioneRichiesteCtl;
...
public class ModuloVisualizzaRichieste extends JFrame implements ActionListener{
	...
	public ModuloVisualizzaRichieste(Utente utente){
		setResizable(false);
		this.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		this.utente = new Utente();
		this.utente = utente;
		
		gestioneRichiesteCtl arraylista = new gestioneRichiesteCtl();
		for(Richiesta richiesta: arraylista.getListaRichieste(this.utente.getMatricola()))
		{
